...
class HiveService {
  ...
  static const String notificationBox = 'in_app_notifications';
  ...
  static Box<InAppNotificationModel> get notifications =>
      Hive.box<InAppNotificationModel>(notificationBox);
